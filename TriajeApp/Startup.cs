...
namespace TriajeApp
{
    public class Startup
    {
        ...
        {
            services.AddCors();
            services.AddDbContext<EncuestaDataContext>();

            services.AddScoped<EncuestaDomainService>();

            services.AddScoped<EncuestaApplicationService>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TriajeApp", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "TriajeApp v1"));
            }
